-- Persist who last changed an assignment so the UI can show current weight + editor.

ALTER TABLE public.kpis
    ADD COLUMN IF NOT EXISTS last_edited_by_name TEXT,
    ADD COLUMN IF NOT EXISTS last_edited_by_role TEXT,
    ADD COLUMN IF NOT EXISTS last_edited_at TIMESTAMPTZ;

ALTER TABLE public.kpi_assignment_edits
