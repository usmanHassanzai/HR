-- New company registrations require platform owner (info@walfia.ai) approval
-- before the organization can be used. Trial starts on approve.
...
-- Trial starts when the platform owner approves (3 days).
